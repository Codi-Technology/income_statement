# Copyright (c) 2013, Anju Prasannan and contributors
...
def execute(filters=None):
	...
	data.append({})
	gross_profit = get_profit(gross_income, gross_expense, period_list, filters.company, 'Profit Margin',filters.presentation_currency)
